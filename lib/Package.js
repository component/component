...
Package.prototype.url = function(remote, file){
...
Package.prototype.getJSON = function(remote, fn){
  var self = this;
  var url = this.url(remote, 'component.json');
...
Package.prototype.getFiles = function(remote, files, fn){
  var self = this;
  var batch = new Batch;

  files.forEach(function(file){
    batch.push(function(done){
      var url = self.url(remote, file);
      debug('fetching %s', url);
...
Package.prototype.reallyInstall = function(){
  ...
  function next() {
    ...
    self.getJSON(self.remote.href, function(err, json){
      if (err) {        
        err.fatal = !last;
      ...
      batch.push(function(done){
        self.mkdir(self.dirname(), function(err){
          self.getFiles(self.remote.href, files, done);
        });
      });
