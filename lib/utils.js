...
/**
 * Open `page` in the default browser.
 *
 * @param {String} page
 */

exports.open = function(page){
  var command = ~process.platform.indexOf('win') ? 'start' : 'open';
  require('child_process').exec([command,page].join(' '));
};
